...
## Learning Paths
- [Discover SAP Business Technology Platform](https://learning.sap.com/learning-journey/discover-sap-business-technology-platform)
- [Getting Started with Web Development](https://learning.sap.com/learning-journey/getting-started-with-ux)
- [Learning the Basics of SAP Fiori](https://learning.sap.com/learning-journey/learn-the-basics-of-sap-fiori)
- [Introducing Cloud Security on SAP Business Technology Platform](https://learning.sap.com/learning-journey/introducing-cloud-security-on-sap-business-technology-platform)
- [Develop SAPUI5 Applications](https://learning.sap.com/learning-journey/develop-sapui5-applications)
- [Build side-by-side extensions on SAP BTP](https://learning.sap.com/learning-journey/build-side-by-side-extensions-on-sap-btp)
...
- [Develop Applications Running on SAP BTP Using SAP HANA Cloud](https://learning.sap.com/learning-journey/develop-applications-running-on-sap-btp-using-sap-hana-cloud)
- [Develop Data Models with SAP HANA Cloud](https://learning.sap.com/learning-journey/develop-data-models-with-sap-hana-cloud)
- [Discovering DevOps with SAP BTP](https://learning.sap.com/learning-journey/discovering-devops-with-sap-btp)
## openSAP Courses
- [Business Technology Platform Tutorials](https://open.sap.com/courses/btpt1)
- [Introduction to SAP Cloud Platform* Extension Suite](https://open.sap.com/courses/cp11)
- [SAP Business Technology Platform in a Nutshell](https://open.sap.com/courses/btp1)
- [Building Applications with SAP Cloud Application Programming Model](https://open.sap.com/courses/cp7) - This course was retired in October, 2022.
- [Working with Calculation Views in SAP HANA Cloud](https://open.sap.com/courses/hana9)
- [Using the Optimizer for SQLScript Programming in SAP HANA](https://open.sap.com/courses/hanasql2)
## SAP Developers YouTube Playlists
...
- [SAP Cloud Application Programming Model](https://www.youtube.com/watch?v=yceqr9vycrs&list=PL6RpkC85SLQDjdUsv1ENsBG43PorsSmbS)
...
- [https://developers.sap.com/group.btp-cf-buildpacks.html](https://developers.sap.com/group.btp-cf-buildpacks.html)
## References
- [SAP Cloud SDK](https://sap.github.io/cloud-sdk/)
- [SAP Cloud Application Programming Model](https://cap.cloud.sap/docs/)
- [Learning SAP skills](https://learning.sap.com/)
- [SAP Developer Center](https://developers.sap.com/)
- [openSAP](https://open.sap.com/)
- [SAP Developers (YouTube)](https://www.youtube.com/@sapdevs)
- [SAP Samples(GitHub)](https://github.com/SAP-samples)